...
public class AntiVirusActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void checkOptionSelect() {
        ...
        if (selectBtnId == R.id.scan_virus_bg) {
            updateSelection(scanVirusTxt, (ConstraintLayout) scanVirusBg, R.id.scan_virus_bg, selectTextColor, selectBgColor);
            updateSelection(secureWifiTxt, (ConstraintLayout) secureWifiBg, R.id.secure_wifi_bg, normalTextColor, normalBgColor);
            updateSelection(appLockTxt, (ConstraintLayout) appLockBg, R.id.app_lock_bg, normalTextColor, normalBgColor);
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, normalTextColor, normalBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, normalTextColor, normalBgColor);

        } else if (selectBtnId == R.id.secure_wifi_bg) {
            updateSelection(scanVirusTxt, (ConstraintLayout) scanVirusBg, R.id.scan_virus_bg, normalTextColor, normalBgColor);
            updateSelection(secureWifiTxt, (ConstraintLayout) secureWifiBg, R.id.secure_wifi_bg, selectTextColor, selectBgColor);
            updateSelection(appLockTxt, (ConstraintLayout) appLockBg, R.id.app_lock_bg, normalTextColor, normalBgColor);
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, normalTextColor, normalBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(scanVirusTxt, (ConstraintLayout) scanVirusBg, R.id.scan_virus_bg, normalTextColor, normalBgColor);
            updateSelection(secureWifiTxt, (ConstraintLayout) secureWifiBg, R.id.secure_wifi_bg, normalTextColor, normalBgColor);
            updateSelection(appLockTxt, (ConstraintLayout) appLockBg, R.id.app_lock_bg, selectTextColor, selectBgColor);
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, normalTextColor, normalBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(secureWifiTxt, (ConstraintLayout) secureWifiBg, R.id.secure_wifi_bg, normalTextColor, normalBgColor);
            updateSelection(appLockTxt, (ConstraintLayout) appLockBg, R.id.app_lock_bg, normalTextColor, normalBgColor);
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, selectTextColor, selectBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(appLockTxt, (ConstraintLayout) appLockBg, R.id.app_lock_bg, normalTextColor, normalBgColor);
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, normalTextColor, normalBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, selectTextColor, selectBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(autoScanTxt, (ConstraintLayout) autoScanBg, R.id.auto_scan_bg, normalTextColor, normalBgColor);
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, selectTextColor, selectBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(secretTxt, (ConstraintLayout) secretBg, R.id.secret_browser_bg, normalTextColor, normalBgColor);
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, selectTextColor, selectBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(cleanJunkTxt, (ConstraintLayout) cleanJunkBg, R.id.clean_junk_bg, normalTextColor, normalBgColor);
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, selectTextColor, selectBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(deleteTxt, (ConstraintLayout) deleteBg, R.id.delete_file_bg, normalTextColor, normalBgColor);
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, selectTextColor, selectBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(removeTxt, (ConstraintLayout) removeBg, R.id.remove_notice_bg, normalTextColor, normalBgColor);
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, selectTextColor, selectBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(similarPhotoTxt, (ConstraintLayout) similarPhotoBg, R.id.similar_photo_bg, normalTextColor, normalBgColor);
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, selectTextColor, selectBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(smartCleanTxt, (ConstraintLayout) smartCleanBg, R.id.smart_clean_bg, normalTextColor, normalBgColor);
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, selectTextColor, selectBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(appManaTxt, (ConstraintLayout) appManaBg, R.id.app_manager_bg, normalTextColor, normalBgColor);
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, selectTextColor, selectBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(clipBoardTxt, (ConstraintLayout) clipBoardBg, R.id.clip_board_bg, normalTextColor, normalBgColor);
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, selectTextColor, selectBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, normalTextColor, normalBgColor);
            ...
            updateSelection(processTXt, (ConstraintLayout) processBg, R.id.process_bg, normalTextColor, normalBgColor);
            updateSelection(tempTxt, (ConstraintLayout) tempBg, R.id.temp_detect_bg, normalTextColor, normalBgColor);
            updateSelection(batteryTxt, (ConstraintLayout) batteryBg, R.id.battery_info_bg, selectTextColor, selectBgColor);
